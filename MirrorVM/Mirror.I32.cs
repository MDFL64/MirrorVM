...
namespace MirrorVM
{
    ...
    struct Const_I32<C> : Expr<int> where C : struct, Const
    {
        [MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
    ...
    {
        [MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
        public int Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => (int)BitOperations.LeadingZeroCount( (uint)default( A ).Run( ref reg, frame, inst ) );
    }
    struct Op_I32_TrailingZeros<A> : Expr<int> where A : struct, Expr<int>
    {
        [MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
        public int Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => (int)BitOperations.TrailingZeroCount( (uint)default( A ).Run( ref reg, frame, inst ) );
    }
    struct Op_I32_PopCount<A> : Expr<int> where A : struct, Expr<int>
    {
        [MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
        public int Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => (int)BitOperations.PopCount( (uint)default( A ).Run( ref reg, frame, inst ) );
    }
