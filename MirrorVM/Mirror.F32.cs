...
namespace MirrorVM
{
	...
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => BitConverter.UInt32BitsToSingle( (uint)default( C ).Run() );
	}
	struct Op_F32_Add<A, B> : Expr<float> where A : struct, Expr<float> where B : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( default( A ).Run( ref reg, frame, inst ) + default( B ).Run( ref reg, frame, inst ) );
	}
	...
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Min( default( A ).Run( ref reg, frame, inst ), default( B ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_Max<A, B> : Expr<float> where A : struct, Expr<float> where B : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Max( default( A ).Run( ref reg, frame, inst ), default( B ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_CopySign<A, B> : Expr<float> where A : struct, Expr<float> where B : struct, Expr<float>
	{
		...
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => MathF.CopySign( default( A ).Run( ref reg, frame, inst ), default( B ).Run( ref reg, frame, inst ) );
	}
	...
	struct Op_F32_Neg<A> : Expr<float> where A : struct, Expr<float>
	{
		// canonicalization not required by spec
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => -default( A ).Run( ref reg, frame, inst );
	}
	struct Op_F32_Abs<A> : Expr<float> where A : struct, Expr<float>
	{
		// canonicalization not required by spec
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => MathF.Abs( default( A ).Run( ref reg, frame, inst ) );
	}
	struct Op_F32_Sqrt<A> : Expr<float> where A : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Sqrt( default( A ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_Floor<A> : Expr<float> where A : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Floor( default( A ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_Ceil<A> : Expr<float> where A : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Ceiling( default( A ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_Truncate<A> : Expr<float> where A : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Truncate( default( A ).Run( ref reg, frame, inst ) ) );
	}
	struct Op_F32_Nearest<A> : Expr<float> where A : struct, Expr<float>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => FloatHelper.CanonicalF32( MathF.Round( default( A ).Run( ref reg, frame, inst ) ) );
	}
	...
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => (uint)default( A ).Run( ref reg, frame, inst );
	}
	...
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => (float)default( A ).Run( ref reg, frame, inst );
	}
	struct Op_F32_Reinterpret_I32<A> : Expr<float> where A : struct, Expr<int>
	{
		[MethodImpl( MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization )]
		public float Run( ref Registers reg, Span<long> frame, WasmInstance inst ) => BitConverter.Int32BitsToSingle( default( A ).Run( ref reg, frame, inst ) );
	}
}
